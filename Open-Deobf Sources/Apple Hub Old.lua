...
local Tabs = {
  Main = Window:AddTab({Title = "Tab Farming", Icon = "rbxassetid:// 122325089010707"}),
  Settings = Window:AddTab({Title = "Tab Setting Farm", Icon = "rbxassetid:// 122325089010707"}),
  Melee = Window:AddTab({Title = "Tab Auto Get Melee V2", Icon = "rbxassetid:// 122325089010707"}),
  Quests = Window:AddTab({Title = "Tab Items Farm", Icon = "rbxassetid:// 122325089010707"}),
  SeaEvent = Window:AddTab({Title = "Tab Sea Events", Icon = "rbxassetid:// 122325089010707"}),
  Mirage = Window:AddTab({Title = "Tab Mirage + RaceV4", Icon = "rbxassetid:// 122325089010707"}),
  Drago = Window:AddTab({Title = "Tab Drago Dojo", Icon = "rbxassetid:// 122325089010707"}),
  Prehistoric = Window:AddTab({Title = "Tab Prehistoric", Icon = "rbxassetid:// 122325089010707"}),
  Raids = Window:AddTab({Title = "Tab Raid", Icon = "rbxassetid:// 122325089010707"}),
  Combat = Window:AddTab({Title = "Tab Combat PVP", Icon = "rbxassetid:// 122325089010707"}),
  Travel = Window:AddTab({Title = "Tab Teleport", Icon = "rbxassetid:// 122325089010707"}),
  Fruit = Window:AddTab({Title = "Tab Fruits", Icon = "rbxassetid:// 122325089010707"}),
  Shop = Window:AddTab({Title = "Tab Shop", Icon = "rbxassetid:// 122325089010707"}),
  Misc = Window:AddTab({Title = "Tab Misc", Icon = "rbxassetid:// 122325089010707"})
}

Tabs.Main:AddButton({
        Title="Link Join Sever Discord",
        Description=" https://discord.gg/kDtgT2299",
        Callback=function()
            setclipboard(tostring(" https://discord.gg/kDtgT2299")) 
        end
})
Tabs.Main:AddSection("Apple Hub 🇻🇳")
