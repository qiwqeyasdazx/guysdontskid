...
local bearlib = (function()
    ...
    local ScreenGui = Inst("ScreenGui",{Name="HoangQoangHub",ResetOnSpawn=false,ZIndexBehavior=Enum.ZIndexBehavior.Sibling})
    pcall(function() ScreenGui.Parent = CoreGui end)
    if not ScreenGui.Parent then ScreenGui.Parent = LocalPlayer.PlayerGui end
    local NotifHolder = Inst("Frame",{Name="Notifs",Size=UDim2.new(0,300,1,0),Position=UDim2.new(1,-310,0,0),BackgroundTransparency=1},ScreenGui)
    local NList = Inst("UIListLayout",{FillDirection=Enum.FillDirection.Vertical,VerticalAlignment=Enum.VerticalAlignment.Bottom,SortOrder=Enum.SortOrder.LayoutOrder,Padding=UDim.new(0,4)},NotifHolder)
    function Library:Notify(o)
        local t=o.Title or"Notify" local m=o.Message or o.Desc or"" local d=o.Duration or 4
        local n=Inst("Frame",{Size=UDim2.new(1,0,0,68),BackgroundColor3=UI.Panel,BorderSizePixel=0},NotifHolder)
        Inst("UICorner",{CornerRadius=UDim.new(0,6)},n)
        Inst("UIStroke",{Color=UI.Accent,Thickness=1},n)
        Inst("Frame",{Size=UDim2.new(0,3,1,0),BackgroundColor3=UI.Accent,BorderSizePixel=0},n)
        Inst("TextLabel",{Text=t,Font=Enum.Font.GothamBold,TextSize=13,TextColor3=UI.Text,Size=UDim2.new(1,-16,0,20),Position=UDim2.new(0,12,0,7),BackgroundTransparency=1,TextXAlignment=Enum.TextXAlignment.Left},n)
        Inst("TextLabel",{Text=m,Font=Enum.Font.Gotham,TextSize=11,TextColor3=UI.TextD,Size=UDim2.new(1,-16,0,30),Position=UDim2.new(0,12,0,28),BackgroundTransparency=1,TextXAlignment=Enum.TextXAlignment.Left,TextWrapped=true},n)
        task.delay(d,function()
            TweenService:Create(n,TweenInfo.new(0.3),{BackgroundTransparency=1}):Play()
            task.wait(0.35) pcall(function() n:Destroy() end)
        end)
    end
    function Library:MakeWindow(o)
        local win={}
        local title=o.Title or"Hub" local sub=o.SubTitle or""
        local Main=Inst("Frame",{Name="Main",Size=UDim2.new(0,640,0,440),Position=UDim2.new(0.5,-320,0.5,-220),BackgroundColor3=UI.BG,BorderSizePixel=0},ScreenGui)
        Inst("UICorner",{CornerRadius=UDim.new(0,8)},Main)
        Inst("UIStroke",{Color=UI.Border,Thickness=1.5},Main)
        local TopBar=Inst("Frame",{Size=UDim2.new(1,0,0,42),BackgroundColor3=UI.AccentD,BorderSizePixel=0},Main)
        Inst("UICorner",{CornerRadius=UDim.new(0,8)},TopBar)
        Inst("Frame",{Size=UDim2.new(1,0,0.5,0),Position=UDim2.new(0,0,0.5,0),BackgroundColor3=UI.AccentD,BorderSizePixel=0},TopBar)
        Inst("TextLabel",{Text="⬡  "..title,Font=Enum.Font.GothamBold,TextSize=14,TextColor3=UI.Text,Size=UDim2.new(0.6,0,1,0),Position=UDim2.new(0,12,0,0),BackgroundTransparency=1,TextXAlignment=Enum.TextXAlignment.Left},TopBar)
        Inst("TextLabel",{Text=sub,Font=Enum.Font.Gotham,TextSize=11,TextColor3=UI.TextD,Size=UDim2.new(0.4,-40,1,0),Position=UDim2.new(0.6,0,0,0),BackgroundTransparency=1,TextXAlignment=Enum.TextXAlignment.Right},TopBar)
        local CloseBtn=Inst("TextButton",{Text="✕",Font=Enum.Font.GothamBold,TextSize=12,TextColor3=UI.Text,Size=UDim2.new(0,28,0,28),Position=UDim2.new(1,-34,0,7),BackgroundColor3=C3(160,25,25),BorderSizePixel=0},TopBar)
        Inst("UICorner",{CornerRadius=UDim.new(0,4)},CloseBtn)
        CloseBtn.MouseButton1Click:Connect(function() Main.Visible=not Main.Visible end)
        local drag,dstart,dpos
        TopBar.InputBegan:Connect(function(i) if i.UserInputType==Enum.UserInputType.MouseButton1 then drag=true dstart=i.Position dpos=Main.Position end end)
        UserInputService.InputChanged:Connect(function(i) if drag and i.UserInputType==Enum.UserInputType.MouseMovement then local d=i.Position-dstart Main.Position=UDim2.new(dpos.X.Scale,dpos.X.Offset+d.X,dpos.Y.Scale,dpos.Y.Offset+d.Y) end end)
        UserInputService.InputEnded:Connect(function(i) if i.UserInputType==Enum.UserInputType.MouseButton1 then drag=false end end)
        local TabBar=Inst("Frame",{Size=UDim2.new(0,145,1,-42),Position=UDim2.new(0,0,0,42),BackgroundColor3=UI.Panel,BorderSizePixel=0},Main)
        Inst("Frame",{Size=UDim2.new(0.5,0,1,0),BackgroundColor3=UI.Panel,BorderSizePixel=0},TabBar)
        local TabScroll=Inst("ScrollingFrame",{Size=UDim2.new(1,0,1,-4),Position=UDim2.new(0,0,0,4),BackgroundTransparency=1,BorderSizePixel=0,ScrollBarThickness=2,ScrollBarImageColor3=UI.Accent},TabBar)
        Inst("UIListLayout",{SortOrder=Enum.SortOrder.LayoutOrder,Padding=UDim.new(0,2)},TabScroll)
        Inst("UIPadding",{PaddingLeft=UDim.new(0,4),PaddingRight=UDim.new(0,4)},TabScroll)
        local ContentArea=Inst("Frame",{Size=UDim2.new(1,-145,1,-42),Position=UDim2.new(0,145,0,42),BackgroundColor3=UI.BG,BorderSizePixel=0},Main)
        Inst("Frame",{Size=UDim2.new(0,1,1,0),BackgroundColor3=UI.Border,BorderSizePixel=0},ContentArea)
        local activePage,tabBtns=nil,{}
        function win:MakeTab(to)
            local tab={}
            local ttl=to.Title or"Tab"
            local TBtn=Inst("TextButton",{Text=ttl,Font=Enum.Font.Gotham,TextSize=11,TextColor3=UI.TextD,Size=UDim2.new(1,0,0,28),BackgroundColor3=UI.TabIn,BorderSizePixel=0,TextXAlignment=Enum.TextXAlignment.Left},TabScroll)
            Inst("UIPadding",{PaddingLeft=UDim.new(0,8)},TBtn)
            Inst("UICorner",{CornerRadius=UDim.new(0,4)},TBtn)
            local Page=Inst("ScrollingFrame",{Size=UDim2.new(1,-6,1,0),Position=UDim2.new(0,5,0,0),BackgroundTransparency=1,BorderSizePixel=0,ScrollBarThickness=3,ScrollBarImageColor3=UI.Accent,Visible=false},ContentArea)
            local PL=Inst("UIListLayout",{SortOrder=Enum.SortOrder.LayoutOrder,Padding=UDim.new(0,3)},Page)
            Inst("UIPadding",{PaddingLeft=UDim.new(0,6),PaddingRight=UDim.new(0,6),PaddingTop=UDim.new(0,5)},Page)
            PL:GetPropertyChangedSignal("AbsoluteContentSize"):Connect(function() Page.CanvasSize=UDim2.new(0,0,0,PL.AbsoluteContentSize.Y+12) end)
            local function sel()
                if activePage then activePage.Visible=false end
                for _,b in pairs(tabBtns) do b.BackgroundColor3=UI.TabIn b.TextColor3=UI.TextD end
                Page.Visible=true activePage=Page TBtn.BackgroundColor3=UI.TabAct TBtn.TextColor3=UI.Text
            end
            table.insert(tabBtns,TBtn) TBtn.MouseButton1Click:Connect(sel)
            if #tabBtns==1 then sel() end
            local function Row(h)
                local r=Inst("Frame",{Size=UDim2.new(1,0,0,h or 34),BackgroundColor3=UI.Panel,BorderSizePixel=0},Page)
                Inst("UICorner",{CornerRadius=UDim.new(0,5)},r)
                return r
            end
            function tab:AddSection(o)
                local name=type(o)=="table" and o[1] or tostring(o)
                local s=Inst("Frame",{Size=UDim2.new(1,0,0,22),BackgroundColor3=UI.Section,BorderSizePixel=0},Page)
                Inst("UICorner",{CornerRadius=UDim.new(0,4)},s)
                Inst("TextLabel",{Text="▸  "..name,Font=Enum.Font.GothamBold,TextSize=11,TextColor3=UI.Text,Size=UDim2.new(1,-10,1,0),Position=UDim2.new(0,8,0,0),BackgroundTransparency=1,TextXAlignment=Enum.TextXAlignment.Left},s)
            end
            function tab:AddToggle(o)
                local name=o.Name or"Toggle" local def=o.Default or false local cb=o.Callback or function()end
                local state=def
                local r=Row(34)
                Inst("TextLabel",{Text=name,Font=Enum.Font.Gotham,TextSize=12,TextColor3=UI.Text,Size=UDim2.new(1,-56,1,0),Position=UDim2.new(0,10,0,0),BackgroundTransparency=1,TextXAlignment=Enum.TextXAlignment.Left,TextTruncate=Enum.TextTruncate.AtEnd},r)
                local bg=Inst("Frame",{Size=UDim2.new(0,38,0,20),Position=UDim2.new(1,-46,0.5,-10),BackgroundColor3=state and UI.TogOn or UI.TogOff,BorderSizePixel=0},r)
                Inst("UICorner",{CornerRadius=UDim.new(1,0)},bg)
                local dot=Inst("Frame",{Size=UDim2.new(0,14,0,14),Position=state and UDim2.new(1,-17,0.5,-7) or UDim2.new(0,3,0.5,-7),BackgroundColor3=UI.Text,BorderSizePixel=0},bg)
                Inst("UICorner",{CornerRadius=UDim.new(1,0)},dot)
                local btn=Inst("TextButton",{Text="",Size=UDim2.new(1,0,1,0),BackgroundTransparency=1},r)
                local function upd()
                    TweenService:Create(bg,TweenInfo.new(0.14),{BackgroundColor3=state and UI.TogOn or UI.TogOff}):Play()
                    TweenService:Create(dot,TweenInfo.new(0.14),{Position=state and UDim2.new(1,-17,0.5,-7) or UDim2.new(0,3,0.5,-7)}):Play()
                end
            ...
            function tab:AddButton(o)
                local name=o.Name or"Button" local cb=o.Callback or function()end
                local r=Row(34)
                local b=Inst("TextButton",{Text=name,Font=Enum.Font.GothamBold,TextSize=12,TextColor3=UI.Text,Size=UDim2.new(1,-16,0,26),Position=UDim2.new(0,8,0.5,-13),BackgroundColor3=UI.Btn,BorderSizePixel=0},r)
                Inst("UICorner",{CornerRadius=UDim.new(0,5)},b)
                b.MouseButton1Click:Connect(function() pcall(cb) end)
            end
            function tab:AddDropdown(o)
                local name=o.Name or"Dropdown" local opts=o.Options or{} local def=o.Default local cb=o.Callback or function()end
                local sel=def
                local cont=Inst("Frame",{Size=UDim2.new(1,0,0,34),BackgroundColor3=UI.Panel,BorderSizePixel=0,ClipsDescendants=true},Page)
                Inst("UICorner",{CornerRadius=UDim.new(0,5)},cont)
                local hdr=Inst("TextButton",{Text="",Size=UDim2.new(1,0,0,34),BackgroundTransparency=1},cont)
                Inst("TextLabel",{Text=name,Font=Enum.Font.Gotham,TextSize=12,TextColor3=UI.Text,Size=UDim2.new(0.55,0,1,0),Position=UDim2.new(0,10,0,0),BackgroundTransparency=1,TextXAlignment=Enum.TextXAlignment.Left},cont)
                local vl=Inst("TextLabel",{Text=tostring(sel or"Select…"),Font=Enum.Font.Gotham,TextSize=11,TextColor3=UI.TextD,Size=UDim2.new(0.45,-28,1,0),Position=UDim2.new(0.55,0,0,0),BackgroundTransparency=1,TextXAlignment=Enum.TextXAlignment.Right,TextTruncate=Enum.TextTruncate.AtEnd},cont)
                Inst("TextLabel",{Text="▾",Font=Enum.Font.Gotham,TextSize=10,TextColor3=UI.Accent,Size=UDim2.new(0,22,1,0),Position=UDim2.new(1,-24,0,0),BackgroundTransparency=1},cont)
                local OH=26 local open=false
                for i,opt in ipairs(opts) do
                    local ob=Inst("TextButton",{Text=opt,Font=Enum.Font.Gotham,TextSize=11,TextColor3=UI.Text,Size=UDim2.new(1,0,0,OH),Position=UDim2.new(0,0,0,34+(i-1)*OH),BackgroundColor3=UI.Input,BorderSizePixel=0},cont)
                    ob.MouseButton1Click:Connect(function() sel=opt vl.Text=opt open=false cont.Size=UDim2.new(1,0,0,34) pcall(cb,opt) end)
                end
                hdr.MouseButton1Click:Connect(function()
                    open=not open
                    cont.Size=UDim2.new(1,0,0,open and (34+math.min(#opts,6)*OH) or 34)
                end)
                if def then pcall(cb,def) end
            end
            function tab:AddTextBox(o)
                local name=o.Name or"Input" local ph=o.Placeholder or"" local def=o.Default or"" local cb=o.Callback or function()end
                local r=Row(52)
                Inst("TextLabel",{Text=name,Font=Enum.Font.Gotham,TextSize=11,TextColor3=UI.TextD,Size=UDim2.new(1,-10,0,16),Position=UDim2.new(0,10,0,4),BackgroundTransparency=1,TextXAlignment=Enum.TextXAlignment.Left},r)
                local inp=Inst("Frame",{Size=UDim2.new(1,-20,0,24),Position=UDim2.new(0,10,0,22),BackgroundColor3=UI.Input,BorderSizePixel=0},r)
                Inst("UICorner",{CornerRadius=UDim.new(0,4)},inp)
                Inst("UIStroke",{Color=UI.Border,Thickness=1},inp)
                local tb=Inst("TextBox",{Text=def,PlaceholderText=ph,Font=Enum.Font.Gotham,TextSize=11,TextColor3=UI.Text,PlaceholderColor3=UI.TextD,Size=UDim2.new(1,-10,1,0),Position=UDim2.new(0,5,0,0),BackgroundTransparency=1,ClearTextOnFocus=false},inp)
                tb.FocusLost:Connect(function() pcall(cb,tb.Text) end)
                if def~="" then pcall(cb,def) end
            end
            function tab:AddLabel(t)
                local txt=type(t)=="table" and (t.Name or t[1]) or tostring(t)
                local r=Inst("Frame",{Size=UDim2.new(1,0,0,26),BackgroundTransparency=1},Page)
                Inst("TextLabel",{Text=txt,Font=Enum.Font.Gotham,TextSize=12,TextColor3=UI.TextD,Size=UDim2.new(1,-10,1,0),Position=UDim2.new(0,10,0,0),BackgroundTransparency=1,TextXAlignment=Enum.TextXAlignment.Left},r)
            end
            function tab:AddParagraph(o)
                local ttl=type(o)=="table" and (o.Title or o[1]) or tostring(o)
                local desc=type(o)=="table" and (o.Desc or o[2] or"") or""
                local r=Row(44)
                Inst("TextLabel",{Text=ttl,Font=Enum.Font.GothamBold,TextSize=12,TextColor3=UI.Text,Size=UDim2.new(1,-10,0,18),Position=UDim2.new(0,10,0,4),BackgroundTransparency=1,TextXAlignment=Enum.TextXAlignment.Left},r)
                local dl=Inst("TextLabel",{Text=desc,Font=Enum.Font.Gotham,TextSize=11,TextColor3=UI.TextD,Size=UDim2.new(1,-10,0,18),Position=UDim2.new(0,10,0,22),BackgroundTransparency=1,TextXAlignment=Enum.TextXAlignment.Left,TextTruncate=Enum.TextTruncate.AtEnd},r)
                local p={} function p:SetDesc(v) dl.Text=tostring(v) end function p:SetTitle(v) end return p
            end
            function tab:AddProfile(o)
                self:AddParagraph({Title=o.Name or"Profile",Desc=o.Bio or""})
            end
            function tab:AddSingleDiscordCard(...)
                local a={...}
                self:AddButton({Name=a[1] or"Link",Callback=function() pcall(function() setclipboard(a[7] or"") end) end})
            end
            function tab:AddDiscordInvite(cards)
                if type(cards)=="table" then
                    for _,c in pairs(cards) do
                        if type(c)=="table" then self:AddSingleDiscordCard(table.unpack(c)) end
                    end
                end
            end
            return tab
...
v0:AddParagraph({
    "Info",
    "•HoangQoang Hub\n• Script by Quang Huy\n• Aura gun does not target boats or leviathan"
})
        ...
        task.spawn(function()
            while _G.AutoBuyMelee do
                ...
                if not data or not data.Pos then
                    bearlib:Notify({
                        Title = "Bear Hub",
                        Message = "Error: No coordinates found for this Melee in current Sea!",
                        Duration = 3
                    })
...
v14:AddButton({
    ...
    Callback = function()
        ...
        bearlib:Notify({Title = "Shop", Message = "Bought: Geppo", Duration = 2})
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        bearlib:Notify({Title = "Shop", Message = "Bought: Buso Haki", Duration = 2})
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        bearlib:Notify({Title = "Shop", Message = "Bought: Soru", Duration = 2})
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        bearlib:Notify({Title = "Shop", Message = "Bought: Observation Haki", Duration = 2})
    end
})

v14:AddSection({"Buy Weapons / Guns"})

v14:AddButton({
    Name = "Buy Cutlass $1,000",
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem", "Cutlass")
        bearlib:Notify({Title = "Shop", Message = "Bought: Cutlass", Duration = 2})
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        bearlib:Notify({Title = "Shop", Message = "Bought: Katana", Duration = 2})
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        bearlib:Notify({Title = "Shop", Message = "Bought: Iron Mace", Duration = 2})
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        bearlib:Notify({Title = "Shop", Message = "Bought: Dual Katana", Duration = 2})
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        bearlib:Notify({Title = "Shop", Message = "Bought: Triple Katana", Duration = 2})
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        bearlib:Notify({Title = "Shop", Message = "Bought: Pipe", Duration = 2})
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        bearlib:Notify({Title = "Shop", Message = "Bought: Dual-Headed Blade", Duration = 2})
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        bearlib:Notify({Title = "Shop", Message = "Bought: Bisento", Duration = 2})
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        bearlib:Notify({Title = "Shop", Message = "Bought: Soul Cane", Duration = 2})
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        bearlib:Notify({Title = "Shop", Message = "Bought: Pole V2", Duration = 2})
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        bearlib:Notify({Title = "Shop", Message = "Bought: Slingshot", Duration = 2})
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        bearlib:Notify({Title = "Shop", Message = "Bought: Musket", Duration = 2})
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        bearlib:Notify({Title = "Shop", Message = "Bought: Flintlock", Duration = 2})
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        bearlib:Notify({Title = "Shop", Message = "Bought: Refined Slingshot", Duration = 2})
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem", "Refined Flintlock")
        bearlib:Notify({Title = "Shop", Message = "Bought: Refined Flintlock", Duration = 2})
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        bearlib:Notify({Title = "Shop", Message = "Bought: Cannon", Duration = 2})
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        bearlib:Notify({Title = "Shop", Message = "Bought: Kabucha", Duration = 2})
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        bearlib:Notify({Title = "Shop", Message = "Bought: Bizarre Rifle", Duration = 2})
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        bearlib:Notify({Title = "Shop", Message = "Bought: Black Cape", Duration = 2})
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        bearlib:Notify({Title = "Shop", Message = "Bought: Swordsman Hat", Duration = 2})
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        bearlib:Notify({Title = "Shop", Message = "Bought: Tomoe Ring", Duration = 2})
    end
})
...
v14:AddButton({
    Name = "Change Race to Ghoul",
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Ectoplasm", "Change", 4)
        bearlib:Notify({Title = "Race", Message = "Changed race to Ghoul", Duration = 2})
    end
})

v14:AddButton({
    Name = "Change Race to Cyborg",
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CyborgTrainer", "Buy")
        bearlib:Notify({Title = "Race", Message = "Changed race to Cyborg", Duration = 2})
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        bearlib:Notify({Title = "Race", Message = "Random Race applied", Duration = 2})
    end
})
...
v15:AddButton({
    ...
    Callback = function()
        ...
        if not RedeemRemote then
            bearlib:Notify({Title = "Error", Message = "Redeem remote not found", Duration = 3})
            return
        end
        ...
        bearlib:Notify({Title = "Success", Message = "All codes attempted", Duration = 3})
    end
})
...
v15:AddButton({
    ...
    Callback = function()
        ...
        bearlib:Notify({Title = "Graphics", Message = "Fast Mode enabled", Duration = 2})
    end
})
