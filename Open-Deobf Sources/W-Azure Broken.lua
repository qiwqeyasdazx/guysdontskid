...
local get_hidden_gui = get_hidden_gui or nil
local gethui = gethui or nil  
local is_sirhurt_closure = is_sirhurt_closure or nil
...
if get_hidden_gui or gethui then
	...
	if hiddenUI and type(hiddenUI) == "function" then
		pcall(function()
...
if not PARENT and (not is_sirhurt_closure) and (syn and syn.protect_gui) then
	pcall(function()
		local Main = Instance.new("ScreenGui")
		Main.Name = randomString()
...
if not PARENT and COREGUI:FindFirstChild('RobloxGui') then
