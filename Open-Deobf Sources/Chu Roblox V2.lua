...
print("--------------------------------------------------------------------------");
local Update = (loadstring(Game:HttpGet("https://raw.githubusercontent.com/giahuy2511-coder/Lol/refs/heads/main/ff785f7a6a5ea5f7.lua.txt")))();
...
spawn(function()
	...
	wait(1);
	((require(game.ReplicatedStorage.Notification)).new("<Color=Yellow>[ YTB: Chú Roblox ]<Color=/>")):Display();
end);
function CheckQuest()
...
MainTab:Button("Copy Discord Link", function()
	setclipboard("https://discord.gg/3EwNuXTNCU");
