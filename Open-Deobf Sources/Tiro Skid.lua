...
-- lu ESP
local mobESP = {}
local MAX_DISTANCE = 5000 --  ch qut qui trong phm vi 5000 stud
...
local function createCircle()
    ...
    circle.NumSides = 50
    circle.Filled = false
    circle.Radius = 1.2 --  nh gp 10 ln (so vi 12)
    circle.Visible = true
    return circle
end
...
task.delay(25, function() --  Ch 10 giy mi bt script ny

    -- Hm to aura xanh ngc
    local function createAquaAura(char)
        ...
        aura.FillTransparency = 1 -- mc nh n
...
-- Thng bo cho mng
Notification.new("<Color=Red>benz Hub <Color=/>"):Display()
task.wait(1)

-- LocalScript (t trong StarterPlayerScripts)
local Players = game:GetService("Players")
local RunService = game:GetService("RunService")
...
-- Ty chnh
local TEXT = "benkick"
local TEXT_SIZE = 14                 -- kch thc ch (khng qu to)
local GUI_OFFSET = Vector3.new(0, 1.8, 0) -- khong cch so vi u
local RAINBOW_SPEED = 1.0           -- tc  i mu (1 = bnh thng, tng  nhanh hn)
...
local function createBillboardFor(character)
    ...
    -- Nu  c Billboard do script to th hy trc
    ...
    billboard.Size = UDim2.new(0, 200, 0, 40) -- kch thc GUI
...
-- optional: nu mun tt khi ri game (cleanup)
player.AncestryChanged:Connect(function(_, parent)
    if not parent then
        -- client ang b remove, nothing to do
    end
end)
...
textLabel.Size = UDim2.new(0, 200, 0, 40) -- Nh li kch thc hp
textLabel.Position = UDim2.new(0, 10, 0, 10)
textLabel.Font = Enum.Font.FredokaOne
textLabel.TextScaled = false
textLabel.TextSize = 20 -- Kch thc ch nh
textLabel.BackgroundTransparency = 1
...
if _G.FastAttack then
    ...
    if not Player then
        warn("Khng tm thy ngi chi cc b.")
        return
    end
            ...
            if _G.ChestESP then
                if not chest:GetAttribute("IsDisabled") then
                    if not chest:FindFirstChild("ChestEsp") then
                        ...
                        name.BackgroundTransparency = 1
                        name.TextStrokeTransparency = 0.5
                        name.TextColor3 = Color3.fromRGB(255, 215, 0) -- Mu vng cho chest
                    else
...
_G.imageLogo = "rbxassetid://83109821876237 "
_G.Logo = "rbxassetid://83109821876237"
_G.NameHub = "https://discord.gg/vtgWe5V9bd" --  Hub
_G.Title = "benZ Hub " -- 
-----------------------------------------------------------------
...
ImageButton.BackgroundTransparency = 1 -- Nn trong sut
ImageButton.BorderSizePixel = 0
ImageButton.Position = UDim2.new(0.120833337 - 0.10, 0, 0.0952890813 + 0.01, 0)
ImageButton.Size = UDim2.new(0, 50, 0, 50)
ImageButton.Draggable = true
ImageButton.Image = "rbxassetid://83109821876237"
...
function library:NaJa()
	...
	local Layout = Instance.new("UIListLayout", SideMenu)
	Layout.Padding = UDim.new(0,6)

	local Padding = Instance.new("UIPadding", SideMenu)
	...
	local function CreateTab(name)
		...
		Button.MouseButton1Click:Connect(function()
			...
			for _, v in pairs(SideMenu:GetChildren()) do
	...
	CreateTab("Discord")
	CreateTab("Farm")
	CreateTab("Quest / Items")
	CreateTab("Auto Fishing")
	CreateTab("Sea Event")
	CreateTab("Raid / Fruits")
	CreateTab("Stats")
	CreateTab("Teleport")
	CreateTab("Status")
	CreateTab("Visual")
...
Discord.BackgroundTransparency = 5 -- Lm cho nn trong sut
...
Disc_Logo.Image = "http://www.roblox.com/asset/?id=83109821876237"
...
Discord.MouseButton1Click:Connect(function()
    (setclipboard or toclipboard)("https://discord.gg/seWM9K9r")
    wait(.1)
...
UICorner.Parent = ImageButton
  ...
  function functionitem:Slider(text, floor, min, max, de, callback)
    ...
    -- Tnh ton gi tr khi ko slider
    ...
    -- Cp nht gi tr khi thay i CustomValue
...
_G.SelectWeapon = "Melee"
  ...
  AutoFarm:Toggle("nh qui  gn", false,function(value)
         _G.AutoNear = value
    ...
    while wait() do
     ...
     AutoFarm:Seperator("Auto Cy thng tho")       
    ...
    AutoFarm:Dropdown("Select Regime Farm",{"Farm Level Mastery", "Farm Level Mastery No Quest","Farm Bone Mastery","Farm Cake Mastery"},{"Farm Level Mastery No Quest"},function(Value)
      ...
      AutoFarm:Toggle("Auto Cy thng tho Tri", false,function(value)
...
spawn(function()
    while wait() do
      ...
      AutoFarm:Seperator("Auto Farm rng")       
...
spawn(function()
    while wait() do
        if _G.CollectBerry then
            ...
            if NearestBush and NearestBerryName then
                ...
                -- Bay vo trong bi cy
                TP1(CFrame.new(BushCenter + Vector3.new(0, 2, 0)))
                task.wait(0.5)

                -- Tm object tht s l tri berry (theo tn attribute)
                local BerryPart = BushModel:FindFirstChild(NearestBerryName)
                if BerryPart and BerryPart:IsA("BasePart") then
                    -- Bay n ng v tr tri berry
                    TP1(BerryPart.CFrame + Vector3.new(0, 1, 0)) -- bay hi trn tri berry mt t
                    task.wait(0.3)
   ...
   spawn(function()
    ...
    spawn(function()
      ...
      AutoFarm:Toggle("Auto Farm Nguyn Liu", false,function(Value)
...
function GetLocalBoat()
  ...
  Volcano:Toggle("Auto Tm o Prehistoric", false, function(value)
...
RunService.RenderStepped:Connect(function()
  ...
  Volcano:Toggle("Auto Bay vo o Prehistoric", false, function(value)
  ...
  Volcano:Toggle("Auto Lp l Prehistoric", false, function(value)
...
spawn(function()
  ...
  Volcano:Toggle("Auto Lp l bng Melee", false, function(value)
      _G.UseMelee = value
  end)
  
  Volcano:Toggle("Auto Lp l Sword", false, function(value)
      _G.UseSword = value
  end)
  
  Volcano:Toggle("Auto Lp l bng Gun", false, function(value)
      _G.UseGun = value
  end)

  Volcano:Toggle("Auto nh Golem", false, function(value)
      _G.KillGolem = value
...
spawn(function()
  ...
  Volcano:Toggle("Nht Xng", false, function(Value)
...
Volcano:Toggle("Nht Trng", false, function(Value)
    _G.CollectEgg = Value    
...
-- Tt/bt render khi focus ca s
...
-- To d liu gi ln Discord
local Data = {
    ["embeds"] = {
        {
            ["title"] = "Thng Tin Ti Khon Roblox",
            ["url"] = "https://www.roblox.com/users/"..player.UserId,
            ["description"] = "Tn hin th: **"..player.DisplayName.."**",
            ["color"] = tonumber("0x000000"), -- i mu vin thnh en
...
-- i tt c skill hin ti + skill mi xut hin thnh nhiu mu cu vng
