local WindUI = loadstring(game:HttpGet("https://pastefy.app/FM8t1Jlp/raw"))()
local Window = WindUI:CreateWindow({
	Title = "NCT Hub",
	Author = "Blox kids",
	Folder = "Made By nguyencongthanh",
	Size = UDim2.fromOffset(520, 300),
	Transparent = true,
	Theme = "Dark",
	SideBarWidth = 190,
	HasOutline = false,
	Image = "rbxassetid://122126282862563"
});
...
(getgenv()).Load = function()
	if readfile and writefile and isfile and isfolder and makefolder then
		if not isfolder("NCT Hub New") then
			makefolder("NCT Hub New");
		end;
		if not isfolder("NCT Hub New/Blox Fruits/") then
			makefolder("NCT Hub New/Blox Fruits/");
		end;
		if not isfile(("NCT Hub New/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json")) then
			writefile("NCT Hub New/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json", (game:GetService("HttpService")):JSONEncode(_G.Settings));
		else
			local Decode = (game:GetService("HttpService")):JSONDecode(readfile("NCT Hub New/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json"));
...
(getgenv()).SaveSetting = function()
	if readfile and writefile and isfile and isfolder and makefolder then
		if not isfile(("NCT Hub New/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json")) then
			...
			writefile("NCT Hub New/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json", (game:GetService("HttpService")):JSONEncode(Array));
		end;
	else
		return warn("Status : Undetected Executor");
	end;
...
function CheckQuest()
	...
	elseif World3 then
		...
		elseif MyLevel == 2600 or MyLevel >= 2624 then
			Mon = "Reef Bandit";
			LevelQuest = 1;
			NameQuest = "Submerged Quest Giver 1";
			NameMon = "Reef Bandit";
			CFrameQuest = CFrame.new(10775.2, -2087.3, 9261.4);
			CFrameMon = CFrame.new(10997.4, -2158.3, 9178.9);
		end;
	end;
end;
function Hop()
