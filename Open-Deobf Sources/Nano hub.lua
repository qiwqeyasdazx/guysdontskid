...
Tabs = {
    Shop = Window:AddTab({ Title = "钮┊Shop", Icon = "" }),
    Server = Window:AddTab({ Title = "钮┊Status Server", Icon = "" }),
    Player = Window:AddTab({ Title = "钮┊Local Player", Icon = "" }),
    Teleport = Window:AddTab({ Title = "钮┊Teleport", Icon = "" }),
    Setting = Window:AddTab({ Title = "钮┊Setting Farm", Icon = "" }),
    Farming = Window:AddTab({ Title = "钮┊Farming", Icon = "" }),
    Stack = Window:AddTab({ Title = "钮┊Stack Farm", Icon = "" }),
    Sub = Window:AddTab({ Title = "钮┊Sub Farming", Icon = "" }),
    Fruit = Window:AddTab({ Title = "钮┊Devil Fruit", Icon = "" }),
    Raid = Window:AddTab({ Title = "钮┊Raid", Icon = "" }),
    Sea = Window:AddTab({ Title = "钮┊Sea Event", Icon = "" }),
    Skill = Window:AddTab({ Title = "钮┊Setting Hold\n Skill Sea Event", Icon = "" }),
    Volcanic = Window:AddTab({ Title = "钮┊Volcanic Event", Icon = "" }),
    Race = Window:AddTab({ Title = "钮┊Upgrade Race", Icon = "" }),
    Item = Window:AddTab({ Title = "钮┊Get Items", Icon = "" }),
    ESP = Window:AddTab({ Title = "钮┊ESP", Icon = "" }),
    PVP = Window:AddTab({ Title = "钮┊PVP", Icon = "" })
}
sex = {
    "WildDares",
    "BossBuild",
...
Toggle = Tabs.Setting:AddToggle("Toggle", {Title = "Fast Attack", Default = true})
...
Tabs.Skill:AddParagraph({
    Title = "钮┊Setting Skill Sword And Gun",
    Content = ""
})
Toggle = Tabs.Skill:AddToggle("Toggle", {
...
Tabs.Volcanic:AddParagraph({
    Title = "钮┊Setting Skill Volcano Island",
    Content = ""
})
Toggle = Tabs.Volcanic:AddToggle("Toggle", {
